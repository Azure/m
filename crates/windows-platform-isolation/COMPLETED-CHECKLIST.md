# windows-platform-isolation — COMPLETED-CHECKLIST

Append-only archive of completed checklist groups.

## Moved 2026-06-21 — Milestone M1: pure safe registry isolation core
...
provider (D15), no on-disk artifact format (D5). 50 unit + integration tests
pass in both debug and release; clippy clean.
