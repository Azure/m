# windows-threadpool — COMPLETED-CHECKLIST

Append-only archive of completed checklist groups. Newest at the bottom.

## Moved 2025-01-09 — M7 async/threadpool foundation (safe core, executor, IOCP reactor, integration)

Detailed execution plan for milestone **M7** of the `windows-platform-isolation`
roadmap. All items implemented, tested (debug + release), and committed
per-item.
...
- [x] **M7-4** *(integration)* End-to-end async smoke: executor + IOCP reactor
