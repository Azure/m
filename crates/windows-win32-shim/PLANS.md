...
|---|---|---|---|
| [CHECKLIST-offproc.md](CHECKLIST-offproc.md) | in progress | Move interception-response work off the calling thread (then out of process) via marshaled JSON work items + a `WaitOnAddress` latch. Milestone OT (off-thread synchronous). | [DESIGN-NOTES.md](DESIGN-NOTES.md) (SHIM-D25) |
