...
namespace m::pil
{
    ...
    // clients expect
    using registry_char_type        = wchar_t;
    using registry_string_type      = std::wstring;
    using registry_string_view_type = std::wstring_view;
    ...
    using registry_char_type        = char;
    using registry_string_type      = std::string;
    using registry_string_view_type = std::string_view;
    ...
    //
    using registry_storage_char_type        = char16_t;
    using registry_storage_string_type      = std::basic_string<registry_storage_char_type>;
    using registry_storage_string_view_type = std::basic_string_view<registry_storage_char_type>;
    ...
    template <typename T>
    void
    to_registry_storage_string(T const& v, registry_storage_string_type& str)
    {
