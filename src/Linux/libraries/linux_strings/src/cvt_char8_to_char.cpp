...
namespace m
{
    ...
    std::string
    string_converter<std::u8string_view, std::string>::make_string(std::u8string_view view)
    {
    ...
    std::string
    string_converter<std::u8string, std::string>::make_string(std::u8string const& str)
    {
        return string_converter<std::u8string_view, std::string>::make_string(
    ...
    std::optional<std::string>
    string_converter<std::u8string, std::string>::make_string(
