...
namespace m
{
    ...
    void
    throw_hresult(HRESULT hr, char const* what);
    ...
    void
    throw_win32_error_code(DWORD error_code, char const* what);
    ...
    void
    throw_error(windows::win32_error_code ec, char const* what);
