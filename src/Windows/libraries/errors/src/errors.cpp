...
void
m::throw_hresult(HRESULT hr, char const* what)
{
...
void
m::throw_win32_error_code(DWORD error_code, char const* what)
{
...
void
m::throw_error(windows::win32_error_code error_code, char const* what)
{
