...
inline auto mb_cp950_t3 = mb_test_data(
    ...
    {
        test_uchar(0xa2), test_uchar{0x4e}, test_uchar(0xa2), test_uchar{0x4f}, test_uchar(0xa2),
        test_uchar{0x59}, test_uchar(0xa2), test_uchar{0x69}, test_uchar(0xa2), test_uchar{0x4e},
        test_uchar(0xa2), test_uchar{0x4f}, test_uchar(0xa2), test_uchar{0x59}, test_uchar(0xa2),
        test_uchar{0x69}, test_uchar(0xa2), test_uchar{0x4e}, test_uchar(0xa2), test_uchar{0x4f},
        test_uchar(0xa2), test_uchar{0x59}, test_uchar(0xa2), test_uchar{0x69}, test_uchar(0xa2),
        test_uchar{0x4e}, test_uchar(0xa2), test_uchar{0x4f}, test_uchar(0xa2), test_uchar{0x59},
        test_uchar(0xa2), test_uchar{0x69},
    },
    L"\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588"sv);
...
inline auto mb_cp950_t4 = mb_test_data(
    m::multi_byte::code_page{950},
    {
        ...
        test_uchar(0xa2), test_uchar{0x59}, test_uchar(0xa2), test_uchar{0x69}, test_uchar(0xa2),
        test_uchar{0x4e}, test_uchar(0xa2), test_uchar{0x4f}, test_uchar(0xa2), test_uchar{0x59},
        test_uchar(0xa2), test_uchar{0x69}, test_uchar(0xa2), test_uchar{0x4e}, test_uchar(0xa2),
        test_uchar{0x4f}, test_uchar(0xa2), test_uchar{0x59}, test_uchar(0xa2), test_uchar{0x69},
        test_uchar(0xa2), test_uchar{0x4e}, test_uchar(0xa2), test_uchar{0x4f}, test_uchar(0xa2),
        test_uchar{0x59}, test_uchar(0xa2), test_uchar{0x69}, test_uchar(0xa2), test_uchar{0x4e},
        test_uchar(0xa2), test_uchar{0x4f}, test_uchar(0xa2), test_uchar{0x59}, test_uchar(0xa2),
        test_uchar{0x69}, test_uchar(0xa2), test_uchar{0x4e}, test_uchar(0xa2), test_uchar{0x4f},
        ...
        test_uchar{0x4f}, test_uchar(0xa2), test_uchar{0x59}, test_uchar(0xa2), test_uchar{0x69},
        test_uchar(0xa2), test_uchar{0x4e}, test_uchar(0xa2), test_uchar{0x4f}, test_uchar(0xa2),
        test_uchar{0x59}, test_uchar(0xa2), test_uchar{0x69},
    },
    L"\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588"
    L"\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588"
    L"\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588\ufe6b\u33d5\u5159\u2588"
...
inline std::array all_multi_byte_test_data{&mb_cp950_t1,
                                           &mb_cp950_t2,
                                           &mb_cp950_t3,
                                           &mb_cp950_t4,
                                           &mb_cp950_t5,
