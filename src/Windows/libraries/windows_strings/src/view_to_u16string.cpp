...
{
    std::u16string_view
    view_converter<wchar_t const*, std::u16string_view>::make_view(cwzstring str)
    {
        if (str == nullptr)
    ...
    std::u16string_view
    view_converter<std::wstring_view, std::u16string_view>::make_view(std::wstring_view view)
    {
        return std::u16string_view(reinterpret_cast<char16_t const*>(view.data()), view.size());
    }

    std::optional<std::u16string_view>
    view_converter<std::wstring_view, std::u16string_view>::make_view(
    ...
    std::u16string_view
    view_converter<std::wstring, std::u16string_view>::make_view(std::wstring const& str)
    {
        return std::u16string_view(reinterpret_cast<char16_t const*>(str.data()), str.size());
    }

    std::optional<std::u16string_view>
    view_converter<std::wstring, std::u16string_view>::make_view(
